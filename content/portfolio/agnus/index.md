...
Where it was done? (course, collaboration, exhibiiton, independent)    
...
Where it was presented/submitted?     
...
## Approach
Explain **how the project works or was carried out**, in broad strokes:

If interactive &rarr; describe the participant experience?    
...
Include visuals (diagrams, screenshots, demos) that showcase the process? 
- Figure 01: Potetnially a gif of Agnus (need to ask Ben)
- Figure 02: Diagrams: flow chart
- Figure 03: Someone interacting with the project
...
Reflection
Summarize why the project matters.
-key insights, results, or lessons learned
...
demo?
- this part can be pushed off till later but it would be interesting, also maybe enforcing a time limit
- 10 min might be too much, maybe by the 2nd min one you'll get the point. 
    - hopefully this also work on mobile but we may be pushing it LOL
- we might need to ask ben for the Agnus file soon.
