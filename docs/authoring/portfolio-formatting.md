...
Portfolio entries have flexible visibility controls through `draft` status and `build` flags. This section clarifies how these interact and when to use each configuration.
